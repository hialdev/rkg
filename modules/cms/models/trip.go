...
type Trip struct {
	...
	UseOpenDates *bool           `json:"use_open_dates,omitempty" gorm:"type:boolean;default:true"`
	UseItinerary *bool           `json:"use_itinerary,omitempty" gorm:"type:boolean;default:false"`
