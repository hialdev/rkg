...
import { EventTypeTableFiltersResult } from '../components/event-type-table-filters-result';
import { EventTypeTableToolbar } from '../components/event-type-table-toolbar';
import { EventTypeTableRow } from '../components/event-type-table-row';
      ...
      <>
         <DashboardContent>
            <CustomBreadcrumbs
               ...
               action={
                  <Button
                     onClick={() => redirect(paths.dashboard.event_types.create)}
                     variant="contained"
            ...
            <Card>
               <EventTypeTableToolbar
                  filters={filters}
                  onResetPage={table.onResetPage}
               />

               {canReset && (
                  <EventTypeTableFiltersResult
                     filters={filters}
                           ...
                           <TableBody>
                              {dataFiltered.map((row) => (
                                 <EventTypeTableRow
                                    ...
                                    editHref={
                                       row.id ? paths.dashboard.event_types.edit(row.id) : ''
                                    }
                                 />
                              ))}
